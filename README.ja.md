...
| Cherry Studio | `$XDG_CONFIG_HOME/CherryStudio/.claude/projects/`（デフォルト `~/.config/CherryStudio/.claude/projects/`；macOS: `~/Library/Application Support/CherryStudio/.claude/projects/`） | `%APPDATA%\CherryStudio\.claude\projects\` | Agent/Claude Code モードのトランスクリプト |
