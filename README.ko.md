...
| Cherry Studio | `$XDG_CONFIG_HOME/CherryStudio/.claude/projects/` (기본값 `~/.config/CherryStudio/.claude/projects/`; macOS: `~/Library/Application Support/CherryStudio/.claude/projects/`) | `%APPDATA%\CherryStudio\.claude\projects\` | Agent/Claude Code 모드 전사 |
