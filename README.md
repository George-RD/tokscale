...
| <img width="48px" src=".github/assets/client-synthetic.png" alt="Reasonix" /> | [Reasonix](https://reasonix.dev/) | `~/.reasonix/projects/` (JSONL sessions with `.jsonl.meta` and checkpoint sidecars) |
